...
const unitStatusConfig: Record<InventoryUnitStatus, { label: string; className: string }> = {
  AVAILABLE: { label: "AVAILABLE", className: "bg-green-900/30 text-green-400 border-green-800/40" },
  RESERVED: { label: "RESERVED", className: "bg-yellow-900/30 text-yellow-400 border-yellow-800/40" },
  SOLD: { label: "SOLD", className: "bg-red-900/30 text-red-400 border-red-800/40" },
  TRANSFERRED: { label: "TRANSFERRED", className: "bg-blue-900/30 text-blue-400 border-blue-800/40" },
  CONSIGNED: { label: "CONSIGNED", className: "bg-purple-900/30 text-purple-400 border-purple-800/40" },
  RETURNED: { label: "RETURNED", className: "bg-surface-container text-muted-foreground border-border/40" },
  LOST_DAMAGED: { label: "LOST/DMG", className: "bg-red-900/20 text-red-300 border-red-800/30" },
  REMOVED: { label: "REMOVED", className: "bg-surface-container/50 text-muted-foreground/50 border-border/20" },
}

export function InventoryUnitStatusBadge({ status }: { status: InventoryUnitStatus }) {
